...
import { Brain, TrendingUp, Target, ChevronRight, BarChart3 } from 'lucide-react';
...
const HeroSection: React.FC<HeroSectionProps> = ({ onScrollToGames, predictionCount, latestSeason }) => {
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="inline-flex items-center gap-2 bg-cyan-500/10 border border-cyan-500/30 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-sm text-cyan-400 font-medium">Logistic Regression Model</span>
            </div>

            {/* Headline */}
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
              NFL Predictions from the{' '}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-5 border border-slate-700 hover:border-cyan-500/50 transition-colors">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Real API Data</h3>
              <p className="text-sm text-slate-400">
                Cards are populated from `GET /predictions`
              </p>
            </div>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-5 border border-slate-700 hover:border-purple-500/50 transition-colors">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Market Inputs</h3>
              <p className="text-sm text-slate-400">
                Spread and moneyline are part of the model features
              </p>
            </div>
